...
const projectData = [
  {
    name: "Snavigation",
    author: "neropunk",
    desc: "Snavigation 一个简约的起始页",
  },
  {
    name: "amlogic-s9xxx-armbian",
    author: "neropunk",
    desc: "Armbian for Amlogic s9xxx tv box. Support s922x, s905x3, s905x2, s912, s905d, s905x, s905w, s905, etc. including install to EMMC and update related functions.",
  },
  {
    name: "MyTT",
    author: "neropunk",
    desc: "MyTT将通达信,同花顺,文华麦语言等指标公式,最简移植到Python中,核心库单个文件，仅百行代码,十几个核心函数，神奇的实现所有常见技术指标算法",
  },
  {
    name: "homehome",
    author: "neropunk",
